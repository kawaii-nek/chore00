...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choeu.catmeow.dpdns.org';
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYmJmYTBlNWMyZmU5NWIxMzRhYTkyNTJjNzQzMDY5YTgiLCJ0IjoiZDcwZWZmN2UtMGM4NS00ZWIwLTg4ZWItYjdlZDI1YjgzNDM0IiwicyI6Ik1qRTNNekJtTURJdE9UWTBOeTAwWkdKaUxUazVZVFV0TlRWbU5UZGtZamMwTWpJeCJ9';
const CFIP = process.env.CFIP || 'ssk.moe';
const NAME = process.env.NAME || 'Cho';
